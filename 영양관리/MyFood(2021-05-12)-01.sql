...
-- 식품정보와 제조자정보를 JOIN 하여  데이터가 정상으로 임포트되었는지 확인
...
-- 세개의 table간에 참조무결성 설정 누가 부모이고, 누가 자손인지 파악
-- 자손 : tbl_foods, 부모 : tbl_compny, tbl_items FK 설정은 자손 table에 설정하기
...
VALUES(seq_myfoods.NEXTVAL,'PD00777','2021-05-11',5);